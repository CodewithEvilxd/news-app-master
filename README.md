...
### [Live Site](https://evilxd-news.netlify.app/)

![](https://github.com/codewithEvilxd/news-app/blob/master/src/components/Images/demo.png)
...
```
git clone https://github.com/codewithEvilxd/news-app.git
```
